...
public class AutoScout {
    public static void main (String[] args) {
        ...
        System.out.print("Scouter First Name? ");
        String scouterName = sc.nextLine();
        System.out.print("Competition? ");
        String competition = sc.nextLine();
        System.out.print("Alliance? (Red 1, Blue 2, etc.) ");
        String allianceColor = sc.next();
        int allianceNumber = sc.nextInt();
        ...
        for (int i = 1; i <= 63; i++) {
            ...
            System.out.println("Q" + i + ":" + finalURL);
